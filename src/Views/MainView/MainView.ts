...
class MainView extends IView {
    ...
    private initComponents(): void {
        ...
        this.components.set('album', new AlbumComponent(this.element.querySelector('main')!, {Id: 0, Name: '', Preview: '', ArtistId: 0, ArtistName: '', Tracks: [], isLiked: false, Single: false}));
