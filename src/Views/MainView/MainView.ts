...
class MainView extends IView {
    ...
    private initComponents(): void {
        ...
        this.components.set('statistics', new StatisticsComponent(this.element.querySelector('main')!, []));
    }
    ...
    public renderStatistics(): void {
        ...
        this.components.get('statistics')!.append();
    }
    ...
    public fillStatistics(statistics: Array<{question: string, avg: number}>): void {
        const feed = this.components.get('statistics') as StatisticsComponent;
